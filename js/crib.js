(function () {
    ...
    template: function(props) {
      return `
        ...
        <section id="user-info">
          ...
          <button type="button" id="settings">${props.user}</button>
  ...
  let lobby = new Reef('#lobby', {
    ...
    template: function(props) {
      return `
        ${props.state === 'login' ? '<section id="identify"></section>' : ''}
        ...
        <div class="tabs">
          ...
          <div id="signup" role="tabpanel" aria-labelledby="tab-signup" hidden="hidden">
            ...
            <form action="">
              ...
              <button type="button" id="signup-submit">Submit</button>
            </form>
          </div>
        </div> `;
    },
        ...
        <div class="hand ${props.game.turn != user && props.game.phase == 'play' ? 'is-disabled' : ''}">
          <div class="header border">
            ...
            <div class="buttons">
              ...
              <button id="deal" ${props.game.phase == 'deal' && props.game.dealer == user ? '' : 'disabled'}>Deal</button>
              <button id="go" ${props.game.phase == 'play' ? '' : 'disabled'}>Go</button>
